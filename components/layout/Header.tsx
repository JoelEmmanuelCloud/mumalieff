        ...
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex items-center justify-between h-12 sm:h-14 md:h-16 w-full">
            ...
            <nav className="hidden lg:flex items-center space-x-4 xl:space-x-6 flex-shrink-0">
              <Link href="/products" className="font-medium text-gray-700 hover:text-primary dark:text-gray-300 dark:hover:text-white transition-colors text-sm xl:text-base whitespace-nowrap">
                All Products
              </Link>
              <Link href="/products/category/Wear Your Conviction" className="font-medium text-gray-700 hover:text-primary dark:text-gray-300 dark:hover:text-white transition-colors text-sm xl:text-base whitespace-nowrap">
                Wear Your Conviction
              </Link>
              <Link href="/products/category/Customize Your Prints" className="font-medium text-accent-gold hover:text-accent-gold-dark dark:text-accent-gold-light dark:hover:text-accent-gold transition-colors text-sm xl:text-base whitespace-nowrap">
              ...
              <div className="hidden md:block relative flex-shrink-0">
                ...
                >
                  ...
                  <span className="hidden lg:inline-block ml-1 font-medium text-sm whitespace-nowrap max-w-[80px] truncate">
                    {isAuthenticated && user ? user.firstName.split(' ')[0] : 'Account'}
                  </span>
                </button>
        ...
        <>
          ...
          >
            ...
            <div className="px-3 py-2 space-y-1 max-h-[calc(100vh-120px)] overflow-y-auto w-full">
              ...
              <Link
                href="/products/category/Wear Your Conviction"
                className="block py-3 px-3 font-medium text-gray-700 hover:text-primary hover:bg-gray-100 dark:text-gray-300 dark:hover:text-white dark:hover:bg-dark-bg rounded-md transition-colors text-sm"
                onClick={() => setIsMenuOpen(false)}
              >
                Wear Your Conviction
              ...
              <Link
                href="/products/category/Customize Your Prints"
