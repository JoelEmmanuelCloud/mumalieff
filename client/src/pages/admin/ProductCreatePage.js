...
const ProductCreatePage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    createProductMutation.mutate({
      ...
      category,
      designStyle: category === 'Wear Your Conviction' ? designStyle : undefined,
      convictionMessage: category === 'Wear Your Conviction' ? convictionMessage.trim() : undefined,
      countInStock,
      material,
      images,
      sizes,
    ...
    <div>
      ...
      <div className="bg-white dark:bg-dark-card rounded-lg shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h1 className="text-2xl font-semibold dark:text-white">Create New Product</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
            ...
            <div>
              ...
              {category === 'Wear Your Conviction' && (
                <div className="mb-4">
                  ...
                  <textarea
                    id="convictionMessage"
                    value={convictionMessage}
                    onChange={(e) => setConvictionMessage(e.target.value)}
                    rows="3"
                    className="form-input"
                    required
                    placeholder="Enter the message or conviction behind this design (max 500 characters)"
                    maxLength={500}
                  ></textarea>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {convictionMessage.length}/500 characters
                  </p>
                </div>
              )}
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded dark:border-gray-600"
                    disabled={category === 'Customize Your Prints'}
                  />
                  <label htmlFor="allowCustomization" className="ml-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    {category === 'Customize Your Prints' && (
                      <span className="text-xs text-gray-500 block">Auto-enabled for Customize Your Prints</span>
                    )}
                  </label>
                </div>
              </div>
          ...
          <div className="flex justify-end space-x-4 border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
            ...
            >
              {createProductMutation.isLoading ? <Loader size="small" /> : 'Create Product'}
            </button>
          </div>
        </form>
      </div>
