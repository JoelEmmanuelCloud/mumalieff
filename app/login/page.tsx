...
import { sendLoginOTP, verifyLoginOTP, resendOTP } from '@/lib/services/otpService';
              ...
              <form onSubmit={handleLoginSubmit}>
                ...
                <div className="mb-4">
                  <div className="flex justify-between">
                    ...
                    <Link href="/forgot-password" className="text-sm text-primary hover:text-primary-light dark:text-accent-blue-light dark:hover:text-accent-blue">
                      Forgot password?
                    </Link>
                  </div>
                  <input
